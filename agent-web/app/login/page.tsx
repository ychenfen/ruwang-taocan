...
function humanizeError(e: unknown): string {
  ...
  if (err.code === "RATE_LIMITED") {
    ...
    if (typeof retry === "number" && Number.isFinite(retry) && retry > 0) return `尝试次数过多，请 ${retry}s 后再试`;
    return "尝试次数过多，请稍后再试";
  }
...
export default function LoginPage() {
  ...
  const hint = useMemo(() => `API: ${apiBaseUrl()}`, []);
  ...
  return (
    <div className="container" style={{ maxWidth: 980 }}>
      ...
      >
        ...
        >
          <div
            style={{
              ...
              inset: -40,
              background:
                "radial-gradient(700px 240px at 15% 10%, rgba(245,158,11,0.18), transparent 60%), radial-gradient(620px 240px at 80% 20%, rgba(14,116,144,0.18), transparent 60%)",
              pointerEvents: "none",
            }}
          />
          <div style={{ position: "relative" }}>
            <div className="brand" style={{ marginBottom: 14 }}>
              ...
              <div>
                ...
                <div className="brandSub">我的网卡 / 团队 / 下级</div>
              </div>
            </div>
            ...
            <div style={{ marginTop: 22, maxWidth: 520 }}>
              ...
              <div style={{ marginTop: 12, color: "var(--muted)", lineHeight: 1.6 }}>
                你会看到：我的在网卡、团队成员与卡（非本人卡号脱敏）、一级/二级同事卡，以及公告通知。
              </div>
        ...
        >
          <div style={{ fontSize: 14, fontWeight: 700, letterSpacing: "-0.02em" }}>职工登录</div>
          <div style={{ marginTop: 6, color: "var(--muted)", fontSize: 12 }}>
            仅职工账号可用此入口（管理员请用 admin-web）。
          </div>
